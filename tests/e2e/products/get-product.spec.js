...
test('deve criar e localizar um produto com sucesso', async ({ page, request }) => {
  ...
  // valida mais dados (opcional, mas forte)
  await expect(linhaProduto).toContainText(produto.nome);
  await expect(linhaProduto).toContainText(produto.preco.toString());
